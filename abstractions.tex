...
The expression adds the \texttt{--latin1} argument to the command line of
the \texttt{Alex} program when building the \texttt{compiler} package.
...
\begin{enumerate}
  ...
  \item \itab{Commutativity:} \tab{\texttt{p ? q ? e \ \ \ \ \ \ == q ? p ? e}}
