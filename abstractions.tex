...
\begin{itemize}
  ...
  changes both in the environment and in the build system itself. \todo{Explain
  how checkArgsHash works?}
...
\todo{Add description of the example (0.5 columns).}
...
\todo{Shall we move it to the beginning of the section?}
...
providing an \textit{escape hatch} where fully-powerful code an be expressed it
