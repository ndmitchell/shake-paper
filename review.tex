...
approach, with rule types such as \lst'cxx_binary' provided, which only require
the name of inputs and outputs, and have knowledge of most flags and conventions
baked in. The disadvantage of such an approach is that the available rules are
fixed, making it difficult to encode something like a bootstrapping compiler.
