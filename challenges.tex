% NEIL: Seems like a good pattern. What we want. How we fake it. How we do it better.
% Abstraction, Composition, Concurrency limiting, Dynamic dependencies, Fine grained dependencies.
