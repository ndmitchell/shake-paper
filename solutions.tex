...
defined throughout the build system. Determining the provenance of each argument
in the final command line is therefore very hard, and is generally not addressed
in build systems. We designed our DSL with the provenance tracking in mind, as
discussed in~\S\ref{sec:expressions}.
